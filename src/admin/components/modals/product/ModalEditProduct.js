...
const ModalEditProduct = (props) => {
    ...
    useEffect(() => {
        if (show) {
            let previewImg = new Buffer(dataProductEdit.img, 'base64').toString('binary')
            setTitle(dataProductEdit.title);
            setDesc(dataProductEdit.desc);
            setAuthor(dataProductEdit.author);
            setPublisher(dataProductEdit.Publisher.id);
            setOldPrice(dataProductEdit.oldPrice);
            setDiscount(dataProductEdit.discount);
            setPrice(dataProductEdit.price);
            setCategory(dataProductEdit.Category.id);
            setQuantityStock(dataProductEdit.quantityStock);
            setImg(previewImg);
        }
                ...
                <Form noValidate validated={validated}>
                    <Row>
                        ...
                        <Form.Group as={Col} md="4" className="mb-3">
                            ...
                            />
                            <Form.Control.Feedback type="invalid">Vui lòng nhập tác giả</Form.Control.Feedback>
                        </Form.Group>
                        <Form.Group as={Col} md="4" className="mb-3">
                        ...
                        <Form.Group as={Col} md="6" className="mb-3 d-flex flex-column">
                            ...
                            />
                            <Form.Control.Feedback type="invalid">Vui lòng cung cấp ảnh</Form.Control.Feedback>
                        </Form.Group>
                    </Row>
                </Form>
            </Container>
